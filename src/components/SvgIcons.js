...
export const CameraIcon = ({ classes, styles }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={classes}
...
export const CloseIcon = ({ classes, styles }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const GoogleIcon = ({ classes, styles }) => {
  return (
...
export const FacebookIconGreen = ({ classes, styles }) => {
  return (
    <svg fill="#3B5998" className={classes} style={styles}>
      <path
...
export const MailIcon = ({ classes, styles }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={classes}
...
export const ArrowLeftIcon = ({ classes, styles }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={classes}
